...
// Module: Main
// Imports: Init GameTheory.ZeroSum
#include <lean/lean.h>
...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("Hello!", 6);
return x_1;
}
}
...
lean_object* initialize_GameTheory_ZeroSum(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_GameTheory_ZeroSum(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
